...
e_min_protein(hh,y,m,aaact,'dairy',inten,minten)$(ord(m) gt 1)..           Sum((feed),v_fdcons(hh,aaact,'dairy',inten,y,m,feed)*p_dryMatter(feed)*p_crudeProtein(feed))*0.9     =g=  p_Protein_req(aaact,'dairy',inten,minten);
