...
*feed sets
feed       'feed sources'          /maize_residue,cpea_residue,grnut_residue,bean_residue,sorgh_residue,millet_residue,banana_residue,maize_silage,sunflower_seed_cake,maize_bran,grass,grass_hay,napier/
feed_off_farm(feed)                /sunflower_seed_cake,maize_bran/
...
grazed(feed)                       /grass/
ration(feed)                       /maize_residue,bean_residue,cpea_residue,grnut_residue,sorgh_residue,millet_residue,maize_silage,grass_hay,napier,sunflower_seed_cake,maize_bran/
...
feedbuy_ration(ration,feed_off_farm) /sunflower_seed_cake.sunflower_seed_cake,maize_bran.maize_bran/
