...
v_Ym_coeff(hh,aaact,type,inten,minten,y,m)                     'Coefficient in the Ym equation'
...
e_Ym_coeff                       'Coefficent for methane conversion facttor (Ym)'
...
e_Ym(hh,aaact,type,inten,minten,y,m)..                                            v_Ym(hh,aaact,type,inten,minten,y,m)       =e= 3.7 - 0.243*v_dryMatterIntake(hh,y,m,aaact,type,inten) + 0.0059*v_ADF(hh,y,m,aaact,type,inten,minten)   +  0.0057*v_dmd(hh,y,m,aaact,type,inten,minten) ;
*9.75 - v_Ym_coeff(hh,aaact,type,inten,minten,y,m) ;
...
e_nitrogen_excretion(hh,aaact,type,inten,minten,y,m)..                            v_nitrogen_excretion(hh,aaact,type,inten,minten,y,m)  =e= v_nitrogen_intake(hh,aaact,type,inten,minten,y,m) - v_nitrogen_retained_lact(hh,aaact,type,inten,minten,y,m) - v_nitrogen_retained_gain(hh,aaact,type,inten,minten,y,m)   ;
